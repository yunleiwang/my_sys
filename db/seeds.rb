...
#   Mayor.create(name: 'Emanuel', city: cities.first)
    ...
    # 初始化菜单
    Menu.create([
                    {name_cn: '控制台',name_en:'',link: '/home/index',seq:1,menu_id:0},
                    {name_cn: '患者信息',name_en:'',link: '#',seq:2,menu_id:0},
                    {name_cn: '患者信息',name_en:'',link: '/patients',seq:1,menu_id:2},
                    {name_cn: '就诊信息',name_en:'',link: '#',seq:3,menu_id:0},
                    {name_cn: '随访信息',name_en:'',link: '#',seq:4,menu_id:0},
                    {name_cn: '系统管理',name_en:'',link: '#',seq:5,menu_id:0},
                    {name_cn: '今日就诊',name_en:'',link: '/patient_visits/today_visits',seq:1,menu_id:4},
                    {name_cn: '就诊列表',name_en:'',link: '/patient_visits',seq:2,menu_id:4},
                    {name_cn: '菜单管理',name_en:'',link: '/menus',seq:1,menu_id:6},
                    {name_cn: '用户管理',name_en:'',link: '#',seq:2,menu_id:6},
                    {name_cn: '角色管理',name_en:'',link: '#',seq:1,menu_id:10},
                    {name_cn: '用户列表',name_en:'',link: '#',seq:2,menu_id:10},
                    {name_cn: '表单管理',name_en:'',link: '#',seq:3,menu_id:6},
                    {name_cn: '字典库管理',name_en:'',link: '#',seq:4,menu_id:6}
